...
module.exports = class ViessmannOAuth2Client extends OAuth2Client {
  ...
  async getFeature({ installationId, gatewaySerial, deviceId, featureName }) {
    return this.get({
  ...
  async setDhwTemp({ installationId, gatewaySerial, deviceId, value }) {
    return this.post({
  ...
  async setHeatingTemp({ installationId, gatewaySerial, deviceId, value }) {
    return this.post({
