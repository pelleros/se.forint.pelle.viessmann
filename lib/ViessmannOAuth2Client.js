...
module.exports = class ViessmannOAuth2Client extends OAuth2Client {
  ...
  */
  ...
  async setHeatingTemp({
    installationId, gatewaySerial, deviceId, heatingCircuitsId, value,
  }) {
    return this.post({
      path: `/features/installations/${installationId}/gateways/${gatewaySerial}/devices/${deviceId}/features/heating.circuits.${heatingCircuitsId}.operating.programs.normal/commands/setTemperature`,
  ...
  async setMainOperatingMode({
    ...
    return this.post({
      path: `/features/installations/${installationId}/gateways/${gatewaySerial}/devices/${deviceId}/features/heating.circuits.${heatingCircuitsId}.operating.modes.active/commands/setMode`,
      json: { mode: value },
    });
  }
